...
from net_aagc import PoseNet_AGC, pose_loss
import pickle
import glob 
import re 
...
def main():
    ...
    model1 = PoseNet_AGC(input_size=12, rotsize=3, adjacency=nira, n_hidden=args.hu1, device=device).to(device)
    model2 = PoseNet_AGC(input_size=15, rotsize=3, adjacency=nira, n_hidden=args.hu2, device=device).to(device)
    model3 = PoseNet_AGC(input_size=15, rotsize=9, adjacency=nira, n_hidden=args.hu3, device=device).to(device)
